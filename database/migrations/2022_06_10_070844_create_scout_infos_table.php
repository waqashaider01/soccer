...
class CreateScoutInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('scout_infos', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('scout_nationality')->nullable();
    ...
    {
        Schema::dropIfExists('scout_infos');
    }
}
