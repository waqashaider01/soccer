        ...
        <div class="container">
            <div class="market-detail">
                <div class="club-seeking-player">
                    <div class="heading" style="background-color: #e5fad1">
                        <h3>Club seeking player</h3>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/market-detail/club-name.png') }}"
                                                class="image-circile-border" alt="city">
                                        </div>
                                        <div class="col-md-9">
                                            <h4 class="title">Club's Name</h4>
                                            <p>{{ $agent->club_name }}</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/market-detail/league-division.png') }}"
                                                alt="city" class="image-circile-border">
                                        </div>
                                        <div class="col-md-9">
                                ...
                                <div class="market-detail-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9 pt-4">
                                            ...
                                            {{-- <p>{{ implode(', ', json_decode(str_replace('-', ' ', $agent->player_position))) }} --}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/market-detail/age.png') }}" alt="city"
                                                class="image-circile-border" id="min-age">
                                        </div>
                                        <div class="col-md-9">
                            ...
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/market-detail/age.png') }}" alt="city"
                                                class="image-circile-border" id="max-age">
                                        </div>
                                        <div class="col-md-9">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Apply For: Club Seeking Player</h5>
