        ...
        <div class="container">
            <div class="market-detail">
                <div class="club-seeking-player">
                    <div class="heading" style="background-color: #b0c1db">
                ...
                <div class="club-details">
                    <div class="heading">
                        <h3>Partnership Request Details</h3>
                    </div>
                    <div class="body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('images/market-detail/club-name.png') }}" alt="city">
                                        </div>
                                        <div class="col-md-9">
                                            <h4 class="title">Originating Partner Country</h4>
                                            <p>{{ $agent->originating_partner_country }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <h4 class="title">Prospective Partner</h4>
                                            <p>{{ $agent->prospective_partner }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            @foreach ($countries as $country)
                                                @if ($country->id == $agent->prospective_partner_country)
                            ...
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <h4 class="title">Prospective Partner Country Wordwide</h4>
                                            @if ($agent->prospective_partner_country_wordwide == 1)
                                                <p>Yes</p>
                                            @else
                                                <p>No</p>
                                            @endif
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Apply For: Partnership Request</h5>
