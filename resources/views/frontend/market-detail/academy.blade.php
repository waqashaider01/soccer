        ...
        <div class="container">
            <div class="market-detail">
                <div class="club-seeking-player">
                    <div class="heading" style="background-color: #b3d7fb">
                        <h3>Academy</h3>
                    </div>
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="market-detail-card">
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <h4 class="title">Academy's Name</h4>
                                            <p>{{ $agent->academy_name }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Apply For: Academy</h5>
