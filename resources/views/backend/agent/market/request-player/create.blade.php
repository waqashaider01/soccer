...
@section('content')
<div class="container">
    <form method="POST" action="{{ route('request-player.market-post-store') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="transfer_fee" name="transfer_fee" value="{{ old('transfer_fee') }}" placeholder="Enter transfer fee">
                </div>
                @error('transfer_fee')
                <div class="text-danger mb-3">{{ $message }}</div>
                @enderror
