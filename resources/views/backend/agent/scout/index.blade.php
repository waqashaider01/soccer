...
<div class="profile">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-achievements-tab" data-bs-toggle="tab" data-bs-target="#nav-achievements"
                type="button" aria-select ed="true">
                <i class="fas fa-project-diagram"></i> scout achievements
            </button>
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active" id="nav-edit_profile" role="tabpanel">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-contact_info-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-contact_info" type="button" aria-selected="false">
                        contact information
                    </button>
                </li>
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-personal_info" role="tabpanel">
                    @include('backend.agent.scout.edit-profile.personal-info')
                </div>{{-- personal-info end --}}

                <div class="tab-pane fade" id="pills-basic_info" role="tabpanel">
                    @include('backend.agent.scout.edit-profile.basic-info')
                </div>{{-- basic-info end --}}

                <div class="tab-pane fade" id="pills-contact_info" role="tabpanel">
                    @include('backend.agent.scout.edit-profile.contact-info')
                </div>{{-- basic-info end --}}

                <div class="tab-pane fade" id="pills-profile_img" role="tabpanel">
                    @include('backend.agent.scout.edit-profile.profile-img')
                </div>{{-- profile-img end --}}

                <div class="tab-pane fade" id="pills-cover_img" role="tabpanel">
                    @include('backend.agent.scout.edit-profile.cover-img')
                </div>{{-- cover-img end --}}
            </div>
