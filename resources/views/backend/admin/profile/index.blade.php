...
<div class="profile">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-career_match_data-tab" data-bs-toggle="tab"
                data-bs-target="#nav-career_match_data" type="button" aria-selected="true">
                <i class="fas fa-chart-area"></i> career match data
            </button>

            <button class="nav-link" id="nav-transfer_history-tab" data-bs-toggle="tab"
                data-bs-target="#nav-transfer_history" type="button" aria-selected="false">
                <i class="fas fa-exchange-alt"></i> transfer history
            </button>

            <button class="nav-link" id="nav-attributes-tab" data-bs-toggle="tab" data-bs-target="#nav-attributes"
                type="button" aria-selected="false">
                <i class="fas fa-chart-pie"></i> attributes
            </button>

            <button class="nav-link" id="nav-next_match_schedule-tab" data-bs-toggle="tab"
                data-bs-target="#nav-next_match_schedule" type="button" aria-select ed="true">
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fade show active" id="nav-edit_profile" role="tabpanel">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-career_info-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-career_info" type="button" aria-selected="false">
                        career information
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-video_links-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-video_links" type="button" aria-selected="false">
                        video links
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="pills-img_upload-tab" data-bs-toggle="pill"
                        data-bs-target="#pills-img_upload" type="button" aria-selected="false">
                        image upload
                    </button>
                </li>
            </ul>
        ...
        <div class="tab-pane fade" id="nav-next_match_schedule" role="tabpanel">
            @include(
            'backend.player.profile.next-match-schedule.index'
            )
