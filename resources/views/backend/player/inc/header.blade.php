...
<nav  class="navbar navbar-expand navbar-light navbar-bg">
    <a class="sidebar-toggle res_ponsive js-sidebar-toggle">
        ...
        <ul class="navbar-nav navbar-align">
            ...
            <li class="nav-item dropdown ">
                ...
                @php
                    ...
                    // @includeIf()
                    // $vie=DB::table('user') ->where('type',$type)->get();
                @endphp
                <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                    ...
                    @isset($views)
                        ...
                        @php
                            $value = $views->first();
                        @endphp
                        <img src="{{ asset('') }}{{ $value->profile_img }}"
                            style="width: 25px;border-radius: 25px !important;height: 25px;" />
                        {{-- @endforeach --}}
                    @endisset
                ...
                <div class="dropdown-menu dropdown-menu-end ">
                    ...
                    <a class="dropdown-item" href={{ route('playersetting') }}><i class="align-middle me-1"
