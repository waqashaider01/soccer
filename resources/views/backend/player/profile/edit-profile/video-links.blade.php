            ...
            @if ($playerInfo != null)
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Video Link 1" id="link1" name="videoLink1">{{ $playerInfo->media_video1 }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Video Link 2" id="link2" name="videoLink2">{{ $playerInfo->media_video2 }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Video Link 3" id="link3" name="videoLink3">{{ $playerInfo->media_video3 }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Video Link 4" id="link4" name="videoLink4">{{ $playerInfo->media_video4 }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" placeholder="Video Link 5" id="link5" name="videoLink5">{{ $playerInfo->media_video5 }}</textarea>
                    </div>
                    <div class="col-md-6 mb-3">
