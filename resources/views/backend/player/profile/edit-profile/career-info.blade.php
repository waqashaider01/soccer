    ...
    @if ($playerInfo != null)
        ...
        <div class="mb-3">
            <label for="nationalTeamPlayer" class="form-label">National Team Player
                *</label>
            <div class="mb-3">
                <input class="form-check-input" type="radio" name="nationalTeamPlayer" id="yes" value="1"
                    {{ $playerInfo->national_team_player == '1' ? 'checked' : '' }}>
                <label for="yes">Yes</label>
                <input class="form-check-input" type="radio" name="nationalTeamPlayer" id="no" value="0"
                    {{ $playerInfo->national_team_player == '0' ? 'checked' : '' }}>
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                <input class="form-check-input" type="radio" name="trainingCompensation" id="yes"
                    value="1" {{ $playerInfo->training_compensation_to_previous_club == '1' ? 'checked' : '' }}>
                <label for="yes">Yes</label>
                <input class="form-check-input" type="radio" name="trainingCompensation" id="no"
                    value="0" {{ $playerInfo->training_compensation_to_previous_club == '0' ? 'checked' : '' }}>
                <label for="no">No</label>
            </div>
        </div>
        <div class="mb-3">
