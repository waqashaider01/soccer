            ...
            <form method="POST" action="/player/basic-info/save">
                ...
                <div class="mb-3">
                    ...
                    <select id="mainPosition" class="form-select" name="mainPosition">
                        ...
                        <option value="left-forward" @if ($playerInfo->main_position == 'left-forward') selected @endif>Left Forward
                        </option>
                        ...
                        <option value="central-midfielder" @if ($playerInfo->main_position == 'central-midfielder') selected @endif>Central
                            Midfielder</option>
                        <option value="right-midfielder" @if ($playerInfo->main_position == 'right-midfielde') selected @endif>Right
                            Midfielder
                        </option>
                        <option value="left-midfielder" @if ($playerInfo->main_position == 'left-midfielder') selected @endif>Left
                            Midfielder
                        </option>
                        ...
                        <option value="central-defender" @if ($playerInfo->main_position == 'central-defender') selected @endif>Central
                            Defender</option>
                        <option value="right-wing-back" @if ($playerInfo->main_position == 'right-wing-back') selected @endif>Right Wing
                            Back
                        </option>
                        <option value="left-wing-back" @if ($playerInfo->main_position == 'left-wing-back') selected @endif>Left Wing
                            Back
                        </option>
                        <option value="goalkeeper" @if ($playerInfo->main_position == 'goalkeeper') selected @endif>Goalkeeper
                        </option>
                    </select>
                </div>
                <div class="mb-3">
                    ...
                    <select id="alternatePosition" class="form-select" name="alternatePosition">
                        ...
                        <option value="second-striker" @if ($playerInfo->alternative_position == 'second-striker') selected @endif>Second
                            Striker
                        </option>
                        ...
                        <option value="attacking-midfielder" @if ($playerInfo->alternative_position == 'attacking-midfielder') selected @endif>
                            Attacking
                            Midfielder</option>
                        ...
                        <option value="left-midfielder" @if ($playerInfo->alternative_position == 'left-midfielder') selected @endif>Left
                            Midfielder
                        </option>
                        <option value="defensive-midfielder" @if ($playerInfo->alternative_position == 'defensive-midfielder') selected @endif>
                            Defensive
                            Midfielder</option>
                        <option value="right-fullback" @if ($playerInfo->alternative_position == 'right-fullback') selected @endif>Right
                            Fullback
                        </option>
                        ...
                        <option value="central-defender" @if ($playerInfo->alternative_position == 'central-defender') selected @endif>Central
                            Defender</option>
                        <option value="right-wing-back" @if ($playerInfo->alternative_position == 'right-wing-back') selected @endif>Right Wing
                            Back
                        </option>
                        <option value="left-wing-back" @if ($playerInfo->alternative_position == 'left-wing-back') selected @endif>Left Wing
                            Back
                        </option>
                        <option value="goalkeeper" @if ($playerInfo->alternative_position == 'goalkeeper') selected @endif>Goalkeeper
                        </option>
                    </select>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <label for="yes">Yes</label>
                        <input class="form-check-input" type="radio" name="haveAgent" id="no"
                            value="0" {{ $playerInfo->have_agent == '0' ? 'checked' : '' }}>
                        <label for="no">No</label>
                    </div>
                </div>
    @endif
