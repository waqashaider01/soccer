...
<div class="mb-3 d-flex justify-content-end">
    <a href="{{ route('player.achievement-create') }}" class="btn add-btn">
...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="{{ route('player.achievement-edit', $achievement->id) }}" class="btn-edit">
                    <i class="fas fa-edit"></i>
                </a>
            </td>
            <td>
                <form method="POST" action="{{ route('player.achievement-delete', $achievement->id) }}">
                    @csrf
                    @method("DELETE")
