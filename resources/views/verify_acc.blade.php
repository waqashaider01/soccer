    ...
    <div class="container">
        <div class="outer">
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6  col ">
                    <div class="position-icon">
                        ...
                        <div class=" icon-done-image text-center"><i class="icon-done-img bi bi-check-circle-fill me-2"></i>
                        </div>
                    </div>
                    <br>
                ...
                <div class="col-md-3 col-sm-6  col">
                    <div class="position-icon">
                        ...
                        <div class=" icon-done-image text-center"><i class="icon-done-img-x bi bi-x-circle-fill me-2"></i>
                        </div>
                    </div>
                    <br>
                    <div class="text-center my-2">
            ...
            <div>
                ...
                <div class="p2"><i class="icon-done bi bi-check2 me-2"></i>Orignal full-size unedited documents</div>
            ...
            @if ($userinfo->count() < 1)
                ...
                <div class="row">
                    <div class="row">
                        <form action="{{ route('cnic_image') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <br>
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-2 imgUp">
                                        ...
                                        <label class="btn btn-primary">Upload<input required name="photofront"
                                                value="abc" type="file" class="uploadFile img" value="Upload Photo"
                                    ...
                                    <div class="col-sm-2 imgUp">
                                        ...
                                        <label class="btn btn-primary">
                                            Upload<input type="file" required name="photoback" class="uploadFile img"
